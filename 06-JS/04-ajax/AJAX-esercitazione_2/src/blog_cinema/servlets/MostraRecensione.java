...
public class MostraRecensione extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(cmd != null && id_recensione > 0) {// richiesta ajax
			...
			// NB: a questo punto, non sarebbe sbagliato sfruttare il file "recensioniJSON.jsp", 
			// ovviamente adattando il metodo "caricaRecensione" di ajax_esercizio_1.js a lavorare su un'array di recensioni 
